...
add_files -fileset sim_1 -norecurse C:\\Users\\khanm\\AppData\\Roaming\\Xilinx\\Vivado\\proj\\part3_tb.sv
...
# Note - LSR IP missing, need to add and connect to empty links on interconnects (and then map addresses again)
